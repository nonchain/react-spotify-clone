  ...
  return (
    <div className='w-full grid grid-cols-5 backdrop-blur-sm cursor-pointer justify-between items-center opacity-80 animate-slideup'>
      ...
      <div className='relative w-14 h-14 overflow-hidden group'>
          <div className={`absolute items-center justify-center bg-black bg-opacity-50 group-hover:flex group-hover:inset-0 ${activeSong?.title === song?.title ? 'flex bg-black bg-opacity-70' : 'hidden'}`}>
            <PlayPause />
          </div>
